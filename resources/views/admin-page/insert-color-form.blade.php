...
@section('content')
    <h1 class="h3 mb-2 text-gray-800">Create Color</h1>
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form action="/admin/insert-color" method="POST" enctype="multipart/form-data">
          {{csrf_field()}}
            <div class="form-group">
              <label for="color_name">Color Name</label>
              <input id="color_name" type="name" class="form-control" name="color_name"  placeholder="Color's Name" required/>
            </div>
