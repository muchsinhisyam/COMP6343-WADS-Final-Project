      ...
      <div class="card-body">
        <form method="POST">
            <div class="form-group">
              ...
              <input id="text" type="name" class="form-control" name="name"  placeholder="Product's Name"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input id="stock "type="text" class="form-control" name="stock" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  placeholder="Product's Qty" required/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="description" rows="3" placeholder="Product's Description"></textarea>
            </div>
            <div class="form-group">
