...
@section('content')
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form action="/admin/categories/{{$selected_category->id}}/update" method="POST" enctype="multipart/form-data">
          {{csrf_field()}}
            <div class="form-group">
              <label for="category_name">Category Name</label>
              <input id="category_name" type="name" class="form-control" name="category_name"  placeholder="Category's Name" value="{{$selected_category->category_name}}" required/>
            </div>
